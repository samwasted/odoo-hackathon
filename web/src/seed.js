...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var i, name_1, email, password, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    name_1 = faker_1.faker.person.fullName();
                    email = faker_1.faker.internet.email({ firstName: name_1.split(" ")[0] });
                ...
                case 2:
                    ...
                    return [4 /*yield*/, db.user.create({
                            data: {
                                ...
                                skillsOffered: faker_1.faker.helpers.arrayElements([
                                ...
                                skillsWanted: faker_1.faker.helpers.arrayElements([
                                    "PROGRAMMING", "DESIGN", "WRITING", "MARKETING", "MUSIC",
                                    "COOKING", "PUBLIC_SPEAKING", "VIDEO_EDITING", "DATA_ANALYSIS"
                                ], faker_1.faker.number.int({ min: 1, max: 4 })),
                            }
