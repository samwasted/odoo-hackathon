...
export function SignupForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (validatedData && typeof onSubmit === 'function') {
    ...
    return (
      ...
      c1.019.005 2.047.138 3.003.403 2.291-1.552 3.297-1.23 3.297-1.23.655 1.653.243 2.873.12 3.176.77.84 1.235 1.911
      ...
      0 .319.19.694.8.576C20.565 22.067 24 17.586 24 12.297 24 5.67 18.627 0.297 12 0.297z"/>
                    ...
                    <div className="bg-muted relative hidden md:block">
                        <img
                            src="https://i.pinimg.com/236x/1e/0b/56/1e0b5667bdbb952a0f3225e79421bad5.jpg"
                            alt="Image"
